...
Monitorix to wolnodostępne i mające otwarte źródła lekkie narzędzie
do monitorowania systemu zaprojektowane do monitorowania jak
największej liczby usług. Aktualnie śledzi parametry od obciążenia
procesora i temperatur do użytkowników korzystających z systemu.
Monitorowane są także żądania usług sieciowych, aktywność interfejsów
sieciowych, a nawet aktywność przerwań urządzeń.
